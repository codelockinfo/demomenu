...
class ProductForm extends HTMLElement{
    ...
    getSelectedVariant() {
        ...
        const options = Array.from(this.form.querySelectorAll('[data-option-selector]'), (select) => select.value);
    ...
    getSelectedSellingPlan() {
        ...
        const availableSellingPlanAllocations = variant.selling_plan_allocations;
        const selectedPlan = this.form.querySelector(this.singlePlanSelector);
        let selectedSellingPlan;

        if( availableSellingPlanAllocations === undefined ) return false;
