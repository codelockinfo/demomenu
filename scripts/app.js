...
class Theme {
    ...
    cartUpdated() {
        if( this.cartCount !== undefined && this.cartCount !== null ){
            this.cartCount.innerHTML = event.detail.cart.item_count;
        }
    }
...
class DrawerTrigger extends HTMLElement{
    ...
    constructor(){
        ...
        this.blackout = this.target.querySelector('[data-blackout]');
        ...
        if( this.blackout !== undefined && this.blackout !== null ){
